...
img = "/home/languagedetection/Gender-Age-Scripts/JPG/AHTD3A0003_Para4.jpg"
...
def pad_crop(crop, contours, edges, border_contour, pad_px=15):
    ...
    for c in c_info:
        ...
        if 0 < int_area < this_area and crop != new_crop:
            print ('{0} -> {1}'.format(str(crop), str(new_crop)))
            changed = True
            crop = new_crop
...
def process_image(path, out_path):
    ...
    print ('{0} -> {1}'.format(path, out_path))


if __name__ == '__main__':
    print(sys.argv[1])
    process_image('/home/languagedetection/Gender-Age-Scripts/JPG/AHTD3A0003_Para4.jpg', '/home/languagedetection/Gender-Age-Scripts/TIFF')
'''
'''
    if len(sys.argv) == 2 and '*' in sys.argv[1]:
        files = glob.glob(sys.argv[1])
        random.shuffle(files)
        print('if {0}'.format(files))
    else:
        files = sys.argv[1:]
        print('else {0}'.format(files))
...
image = img_as_float(io.imread('JPG/AHTD3A0003_Para4.jpg'))
